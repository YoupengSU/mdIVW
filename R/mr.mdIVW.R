...
#' @param Gamma_se The standard errors associated with the beta-coefficients \code{Gamma_hat}.
#' @param rs_hst A numeric vector of beta-coefficient values for genetic associations with the exposure variable, which will be used for the IV selection. \code{rs_hat} should be provided when \code{delta} is not zero. See 'Details'.
